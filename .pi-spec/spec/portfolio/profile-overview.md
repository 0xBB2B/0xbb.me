...
## 目的
让不操作游戏或无法运行图形的访客，直接取得与 NPC 介绍及看板一致的个人资料与作品入口。

## 逻辑
主页提供明显的资料速览入口，不需要先行走或完成对话。
打开后展示简介、技能、作品与联系方式，并暂停行走。
资料、NPC 台词和看板表达相同事实，不虚构履历或成果。
...
- C-2：系统应按顺序展示 AI Agent、Golang、Docker/k8s、游戏发行SDK、支付平台共 5 项技能及中性领域介绍，不显示等级、分数、百分比或评级；看板、资料速览和故障阅读的内容一致，不虚构成果。
...
| 作品 | 介绍要点 | 访问入口 | 源码入口 |
|---|---|---|---|
| 0xbb.me | 可操控角色、迎宾NPC、技能与作品看板组成的三场景HD-2D个人主页 | https://0xbb.me | https://github.com/0xBB2B/0xbb.me |
